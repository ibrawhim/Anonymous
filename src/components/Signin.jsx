...
const Signin = () => {
  ...
  return (
    ...
    <section className='sm:mt-16' >
        <form onSubmit={formik.handleSubmit} style={mySection} className='lg:top-[30%] top-[50%] bg-blue-950 p-10 lg:rounded-2xl rounded lg:w-1/3 w-full  my-2 sm:my-10 md:my-20'  action="">
